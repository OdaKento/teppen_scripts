...
public class CameraControl : MonoBehaviour
{
    ...
    [SerializeField] SceneControlManager _sceneManager;
    ...
    void Start()
    {
        ...
        {
            _textObject[i].text = _sceneDataBase.SceneBaseList[(int)_sceneControl._SceneType[i]].textName;
        }
    ...
    private void FixedUpdate()
    {
        if (changeF)
        {
            ...
            if (changeCount > 60)
            {
                _sceneManager.changeScene(_sceneDataBase.SceneBaseList[(int)_sceneControl._SceneType[modeNumber]].sceneName, SceneControl._changeSceneTime);
            }
